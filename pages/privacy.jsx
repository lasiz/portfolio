const Privacy = () => {
    ...
    <p>
      ...
      your information when you use our Telegram bot, "
      <strong>TMDB_LISTBOT</strong>". Please read this privacy policy
      carefully. If you do not agree with the terms of this privacy policy,
      please do not access the bot.
    </p>
    <h2>1. Information We Collect</h2>
    <p>
      We may collect information about you in a variety of ways. The information
      we may collect via the bot includes:
    </p>
    <ul>
      <li>
        <strong>Personal Data:</strong> Personally identifiable information,
        such as your Telegram username and any information you voluntarily
        provide, including media files such as movies and videos, which may be
        associated with your Telegram account.
      </li>
      <li>
        <strong>Usage Data:</strong> Information about your interactions with
        the bot, including the commands you use and the frequency of your
        interactions.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        To respond to your inquiries and fulfill your requests, such as sending
        media files.
      </li>
      <li>To improve the bot’s performance and user experience.</li>
    </ul>
    ...
    <p>
      ...
      the age of 13. If we learn we have collected information from a child
